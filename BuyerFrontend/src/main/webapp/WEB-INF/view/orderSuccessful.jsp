...
<div class=page-title><h1>Order Was Successful.</h1></div>
<div class=page-title><h2>Kindly pay Rs.${orderAmount} to the delivery agent on delivery.</h2></div>
<div class=page-title><h3><a href="/seeOrders">Click Here To Go To Orders Page</a></h3></div>
</body>
</html>